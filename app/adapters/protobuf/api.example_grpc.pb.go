...
type ExampleServiceClient interface {
	Example(ctx context.Context, in *RequestExample, opts ...grpc.CallOption) (*ResponseExample, error)
}
...
func (c *exampleServiceClient) Example(ctx context.Context, in *RequestExample, opts ...grpc.CallOption) (*ResponseExample, error) {
	out := new(ResponseExample)
...
type ExampleServiceServer interface {
	Example(context.Context, *RequestExample) (*ResponseExample, error)
...
func (UnimplementedExampleServiceServer) Example(context.Context, *RequestExample) (*ResponseExample, error) {
...
func _ExampleService_Example_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExampleServiceServer).Example(ctx, req.(*RequestExample))
	}
